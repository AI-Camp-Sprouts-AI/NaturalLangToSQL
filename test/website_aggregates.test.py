...
test_cases = [
    {
        ...
        'sql_output': "SELECT SUM(no_of_visiting_ips) FROM website_aggregates WHERE customer_domain = <domain>;",
    ...
    },
    {
        ...
        'sql_output': "SELECT SUM(no_of_visiting_ups) FROM website_aggregates WHERE dt >= current_date - INTERVAL '7 days';",
    ...
    },
    {
        ...
        'sql_output': "SELECT SUM(no_of_visiting_ips) FROM website_aggregates WHERE EXTRACT(YEAR FROM dt) = 2022;",
    ...
    },
    {
        ...
        'sql_output': "SELECT SUM(no_of_visiting_ips) FROM website_aggregates WHERE estimated_num_employees BETWEEN <min_count> AND <max_count>;",
    ...
    },
    {
        ...
        'sql_output': "SELECT SUM(no_of_visiting_ips) FROM website_aggregates WHERE revenue_range BETWEEN <min_revenue> AND <max_revenue>;",
    ...
    },
    {
        ...
        'sql_output': "SELECT SUM(no_of_visiting_ips) FROM website_aggregates WHERE ip_country = 'United States';",
